...
def upgrade() -> None:
    if not _has_table("organization_subscriptions"):
        op.create_table(
    ...
    # Indexes
    if not _has_index("organization_subscriptions", "ix_org_subscriptions_org_id"):
        op.create_index("ix_org_subscriptions_org_id", "organization_subscriptions", ["organization_id"])
    if not _has_index("organization_subscriptions", "ix_org_subscriptions_stripe_customer"):
        op.create_index("ix_org_subscriptions_stripe_customer", "organization_subscriptions", ["stripe_customer_id"])
    if not _has_index("organization_subscriptions", "ix_org_subscriptions_stripe_sub"):
        op.create_index("ix_org_subscriptions_stripe_sub", "organization_subscriptions", ["stripe_subscription_id"])
    if not _has_index("organization_subscriptions", "ix_org_subscriptions_status"):
