                ...
                "properties": {
                    "use": {
                        ...
                        "properties": {
                            "ai_training": {
                                "type": "boolean",
                                "description": "Allow use for AI training"
                            },
                            "ai_inference": {
                                "type": "boolean",
                                "description": "Allow use for AI inference"
                            },
                            "data_mining": {
                                "type": "boolean",
                                "description": "Allow data mining"
                            }
                        },
        ...
        },
        {
            ...
            "schema": {
                ...
                "properties": {
                    "claim_reviewed": {
                        "type": "string",
                        "description": "The claim being reviewed"
                    },
                    "rating": {
                        "type": "string",
                        "description": "Review rating or verdict"
                    },
                    "appearance_url": {
                        "type": "string",
                        "format": "uri",
                        "description": "URL where claim appears"
                    },
                    "author": {
                        "type": "object",
                        "properties": {
                    ...
                    "url": {
                        "type": "string",
                        "format": "uri",
                        "description": "URL to full review"
                    }
                },
        ...
        },
        {
            ...
            "schema": {
                ...
                "properties": {
                    ...
                    "identifier": {
                        "type": "string",
                        "description": "Unique identifier for thumbnail"
                    },
                    "thumbnail": {
                        "type": "string",
    ...
    return [
        ...
        },
        {
            ...
            "assertions": [
                {
                    "label": "c2pa.actions.v1",
                    "description": "Research workflow tracking"
                },
                {
                    "label": "c2pa.training-mining.v1",
