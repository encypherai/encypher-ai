...
class SessionService:
    ...
    async def create_session(
        self, organization_id: str, session_type: str = "websocket", metadata: Optional[Dict[str, Any]] = None, ttl_seconds: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        ...
        session_data = {
            ...
            "chunks_processed": 0,
            "buffer_state": {"accumulated_text": "", "is_accumulating": False, "has_encoded": False},
        ...
        if self.redis_client:
            try:
                await self.redis_client.setex(self._get_session_key(session_id), ttl, json.dumps(session_data))
    ...
    async def get_session(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if session_json:
                session_data = cast(Dict[str, Any], json.loads(session_json))
    ...
    async def update_buffer_state(self, session_id: str, accumulated_text: str, is_accumulating: bool, has_encoded: bool) -> bool:
        """
        ...
        return await self.update_session(
            session_id, {"buffer_state": {"accumulated_text": accumulated_text, "is_accumulating": is_accumulating, "has_encoded": has_encoded}}
        )
    ...
    async def increment_chunks_processed(self, session_id: str) -> bool:
        ...
        return await self.update_session(session_id, {"chunks_processed": session_data["chunks_processed"] + 1})
    ...
    async def close_session(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        logger.info(f"Session closed: {session_id}, chunks_processed={session_data['chunks_processed']}, duration={duration:.2f}s")
