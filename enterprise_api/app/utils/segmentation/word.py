...
def segment_words_simple(text: str, 
...
def segment_words_with_positions(text: str, 
                                 include_punctuation: bool = False) -> List[tuple[str, int, int]]:
    """
...
def segment_words_normalized(text: str,
                            lowercase: bool = True,
