...
try:
    ...
    try:
        ...
        logger.warning("Install with: uv pip install https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.8.0/en_core_web_sm-3.8.0-py3-none-any.whl")
        _default_nlp = None
...
def segment_sentences_default(text: str, 
...
def segment_words_default(text: str,
                          normalize: bool = True,
...
def normalize_for_hashing(text: str, 
                         lowercase: bool = True,
                         normalize_unicode_chars: bool = True) -> str:
    """
...
class DefaultSegmenter:
    ...
    def __init__(self, model_name: str = "en_core_web_sm"):
        ...
        if not SPACY_AVAILABLE:
            raise ImportError(
                "spaCy is required for default segmenter. "
    ...
    def segment_words(self, text: str, 
                     ...
                     remove_punctuation: bool = False) -> List[str]:
        """Segment into words."""
        return segment_words_default(text, normalize=normalize, 
                                     remove_punctuation=remove_punctuation)
    
    def normalize_for_hashing(self, text: str,
