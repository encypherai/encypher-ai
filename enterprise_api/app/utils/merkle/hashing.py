...
def normalize_text(text: str, lowercase: bool = False, remove_whitespace: bool = False, remove_punctuation: bool = False) -> str:
    """
...
def compute_normalized_hash(text: str, lowercase: bool = False, remove_whitespace: bool = False, remove_punctuation: bool = False) -> str:
    """
    ...
    """
    normalized = normalize_text(text, lowercase=lowercase, remove_whitespace=remove_whitespace, remove_punctuation=remove_punctuation)
    return compute_hash(normalized)
