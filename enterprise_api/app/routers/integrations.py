...
@router.get(
    ...
    description="Retrieve the current WordPress integration configuration and install status for the authenticated organization.",
)
...
@router.post(
    ...
    description="Update the WordPress integration status fields from the WordPress plugin.",
)
...
@router.post(
    ...
    description="Register a new WordPress site install or update an existing record for the authenticated organization.",
)
...
@router.post(
    ...
    description="Record a content verification event generated by the WordPress plugin for tracking and audit.",
)
...
@router.post(
    ...
    description="Queue a remote management action to be delivered to a specific WordPress install.",
)
...
@router.post(
    ...
    description="Pull pending remote actions queued for a specific WordPress install, called on a polling interval.",
)
...
@router.post(
    ...
    description="Acknowledge completion of a remote action by the WordPress plugin, recording the result.",
)
...
@router.post(
    ...
    description="Initiate a magic-link connection flow for linking a WordPress site to an Encypher account.",
)
...
@router.get(
    ...
    description="Poll the status of a WordPress magic-link connect session to check approval.",
)
...
@router.post(
    ...
    description="Complete the WordPress magic-link connection flow using the token from the approval email.",
)
