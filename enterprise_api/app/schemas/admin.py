    ...
    class Config:
        json_schema_extra = {
            "example": {
                "user_id": "user_abc123",
                "new_tier": "enterprise",
                "reason": "Upgraded per sales agreement"
            }
        }
        ...
        json_schema_extra = {
            "example": {
                ...
                "data": {
                    ...
                    "new_tier": "enterprise",
                    "updated_at": "2024-12-23T22:00:00Z"
                }
            }
        }
...
class PublicKeyRegisterRequest(BaseModel):
    ...
    public_key_pem: str = Field(
        ..., 
        description="PEM-encoded public key (Ed25519 or RSA)",
        min_length=50
    )
    ...
    key_algorithm: str = Field(
        default="Ed25519",
        description="Key algorithm (Ed25519, RSA-2048, RSA-4096)"
    )
