...
class StatusListEntry(Base):
    ...
    organization_id = Column(String(64), ForeignKey("organizations.id", ondelete="CASCADE"), primary_key=True)
    ...
    def __repr__(self) -> str:
        ...
        return f"<StatusListEntry(doc={self.document_id}, org={self.organization_id}, list={self.list_index}, bit={self.bit_index}, status={status})>"
