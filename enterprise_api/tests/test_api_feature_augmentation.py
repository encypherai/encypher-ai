    ...
    def test_embedding_strategy_invalid_raises_error(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            EncodeWithEmbeddingsRequest(
                document_id="test-doc",
                text="Test content.",
                embedding_strategy="invalid_strategy"
            )
    ...
    def test_distribution_target_invalid_raises_error(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            EncodeWithEmbeddingsRequest(
                document_id="test-doc",
                text="Test content.",
                distribution_target="invalid_target"
            )
...
class TestFingerprintSchemas:
    ...
    def test_fingerprint_encode_request_defaults(self):
        ...
        request = FingerprintEncodeRequest(
            document_id="test-doc",
            text="Test content for fingerprinting."
        )
...
class TestDualBindingService:
    ...
    def test_verify_dual_binding_valid(self, keys):
        ...
        is_valid, message, info = service.verify_dual_binding(
            manifest_bytes, text, public_key
        )
    ...
    def test_verify_dual_binding_content_modified(self, keys):
        ...
        is_valid, message, _ = service.verify_dual_binding(
            manifest_bytes, modified_text, public_key
        )
