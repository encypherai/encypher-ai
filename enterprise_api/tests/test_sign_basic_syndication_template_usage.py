...
@pytest.mark.asyncio
async def test_sign_basic_applies_news_wire_syndication_template_assertions() -> None:
    request = SignRequest(
        text="Hello world.",
    ...
    core_db = AsyncMock()
    allocate_mock = AsyncMock(return_value=(0, 3, "https://verify.encypherai.com/status/v1/lists/00000000-0000-0000-0000-000000000b01"))
