...
async def test_sign_basic_embeds_status_list_assertion() -> None:
    ...
    allocate_mock = AsyncMock(return_value=(3, 12, "https://verify.encypher.com/status/v1/lists/00000000-0000-0000-0000-000000000b04"))
    ...
    assert any(
        ...
        == "https://verify.encypher.com/status/v1/lists/00000000-0000-0000-0000-000000000b04"
