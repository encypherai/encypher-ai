...
This guide will help you get started with Encypher for embedding and extracting metadata from AI-generated text.
...
Encypher fully supports streaming, allowing you to process and embed metadata in real-time as text chunks are generated by an LLM.
