...
| Extensions | .svg |
| Category | Image |
| Pipeline | c2pa-rs (c2pa-python Builder, XML/SVG embedding via processing instruction) |
| Hash assertion | c2pa.hash.data (byte-range exclusion) |
| Thumbnail in manifest | No |
| Conformance suite entry | Yes |

SVG manifests are embedded as a JUMBF data block referenced from an XML processing instruction
in the SVG document. c2pa-rs handles this automatically via its SVG codec.
...
| Fixture file size | 355 bytes |
| Signed file size | 19,933 bytes |
| Sign result | PASS |
| Signed file | tests/c2pa_conformance/signed/signed_test.svg |
| Manifest JSON | tests/c2pa_conformance/manifests/signed_test_svg.json |

## Manifest Details

| Field | Value |
|-------|-------|
| active_manifest | urn:c2pa:619245ec-80ac-4761-81f2-79cd0bb0887e |
| title | C2PA Conformance Test -- SVG |
| instance_id (manifest) | xmp:iid:f93b3365-e1a5-4045-9856-ea744dccae9f |
...
| com.encypher.provenance | organization_id: encypher-conformance, document_id: conformance-svg, image_id: 6d4aed18-6863-4ba6-af5a-5a6d30add902 |

Note: SVG does not include a thumbnail assertion (no thumbnail for vector formats).

## Internal Verification Results

Source: tests/c2pa_conformance/results/verify_results.json

verify_results instance_id: urn:uuid:9777e713-0b15-499e-8144-b8b41a8da878
...
| Screenshot | [svg_adobe_verify.png](../screenshots/svg_adobe_verify.png) |
