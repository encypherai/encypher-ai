      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-3 mb-4">
            <div className="w-12 h-12 bg-columbia-blue rounded-lg" />
            <h1 className="text-3xl font-bold text-white">Encypher</h1>
          </div>
          <p className="text-columbia-blue/80">Sign in to your dashboard</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/forgot-password" className="text-columbia-blue hover:text-blue-ncs">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link href="/signup" className="text-columbia-blue hover:text-blue-ncs font-medium">
                Sign up for free
              </Link>
            </div>
          </CardContent>
