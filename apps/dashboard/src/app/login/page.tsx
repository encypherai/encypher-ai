        ...
        <div className="relative z-20 max-w-md px-12 text-white">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-medium mb-6">
              ...
              C2PA Certified Infrastructure
            </div>
            <h2 className="text-3xl font-bold leading-tight mb-4">
              Your content.<br />Your rights.<br />Verifiable anywhere.
            </h2>
            <p className="text-white/80 text-base leading-relaxed">
              Embed cryptographic provenance into every document you publish. When AI systems access your content, you have evidence.
            </p>
          </div>
          <div className="space-y-4">
            {[
              { icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', text: 'Invisible C2PA signing in every document' },
              { icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z', text: 'Track AI crawlers and measure compliance' },
