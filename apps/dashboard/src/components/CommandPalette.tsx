...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    { id: 'docs', title: 'Open API Documentation', icon: <IconDocs />, action: () => window.open('https://api.encypher.com/docs', '_blank'), keywords: ['help', 'guide', 'reference', 'api'], category: 'action' },
