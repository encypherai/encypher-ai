...
const onboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: 'Check out our Publisher Integration Guide for step-by-step instructions, or dive into the interactive API reference.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    action: {
      label: 'Publisher Integration Guide',
