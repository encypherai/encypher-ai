      ...
      >
        ...
        <div className="flex items-center h-16 px-4 border-b border-white/10 flex-shrink-0">
          <Link href="/" className="flex items-center min-w-0">
            {sidebarCollapsed ? (
              <Image
                src="/assets/mark-white-nobg.svg"
                alt="Encypher"
                width={28}
                height={28}
                className="h-7 w-7"
              ...
              <Image
                src="/assets/wordmark-white-nobg.svg"
                alt="Encypher"
                width={120}
                height={30}
        ...
        <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-4">
          ...
          {/* Internal links (brand assets + admin) */}
          {showBrandAssets && (
            <div>
              {!sidebarCollapsed && (
                <p className="px-3 mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-white/40">
              ...
              <Link
                href="/brand"
                title={sidebarCollapsed ? 'Brand Assets' : undefined}
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 ${
                  isActive('/brand')
                    ? 'bg-white/15 text-white'
                    : 'text-white/70 hover:bg-white/10 hover:text-white'
              ...
              >
                ...
                {!sidebarCollapsed && <span>Brand Assets</span>}
              </Link>
              {isAdmin && (
                <Link
                  href="/admin"
