...
const DELFT_NAVY = '#1b2f50';
const BLUE_NCS = '#2a87c4';
const COLUMBIA_BLUE = '#b7d5ed';
const SLATE_800 = '#1e293b';

// Encypher mark SVG paths (from packages/icons/src/paths.ts)
const MARK_GROUP_TRANSFORM = 'translate(12.7657,8.6617)';
const MARK_PATHS = [
  {
...
export async function GET(request: NextRequest) {
  ...
  const title = searchParams.get('title') || 'Machine-Readable Rights for Your Content';
  ...
  return new ImageResponse(
    (
      <div
        style={{
          ...
          height: '100%',
          display: 'flex',
          backgroundColor: DELFT_NAVY,
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        {/* Background: large brand mark, clearly visible */}
        <div
          style={{
            position: 'absolute',
            right: -30,
        ...
        <div
          style={{
            ...
            right: 0,
            height: 6,
            background: `linear-gradient(90deg, ${BLUE_NCS}, ${COLUMBIA_BLUE}, ${BLUE_NCS})`,
            display: 'flex',
          }}
        />

        {/* Main content - minimal padding, fill the space */}
        <div
          style={{
            display: 'flex',
        ...
        >
          {/* Full wordmark logo + badge on same row */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            <svg width="680" height="122" viewBox="0 0 134 24">
              {/* Mark */}
              <g transform={MARK_GROUP_TRANSFORM}>
                {MARK_PATHS.map((p, i) => (
                  <path
              ...
              <path
                fill="white"
                transform="matrix(0.02327545,0,0,0.02327545,25.477180,19.391809)"
                d={WORDMARK_PATH}
              />
            </svg>
          ...
          {/* Description - larger for small previews */}
          {displayDesc && (
            <div
              style={{
                fontSize: 38,
        ...
        <div
          style={{
            ...
            padding: '16px 48px',
            backgroundColor: `${SLATE_800}e0`,
            borderTop: `2px solid ${BLUE_NCS}40`,
          }}
        >
          <div
            style={{
    ...
    ),
    {
      ...
      height: 630,
      fonts: [
        { name: 'Roboto', data: robotoBold, weight: 700, style: 'normal' as const },
        { name: 'Roboto', data: robotoRegular, weight: 400, style: 'normal' as const },
      ],
    },
  );
}
