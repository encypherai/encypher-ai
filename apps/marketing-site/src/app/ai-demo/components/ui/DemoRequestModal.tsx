...
export default function DemoRequestModal({ onClose }: DemoRequestModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackEvent('demo_form_submitted', { requestId: data.id });
      setIsSuccess(true);
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-slate-900">Schedule Technical Deep Dive</h2>
          <button
            onClick={onClose}
          ...
          {isSuccess ? (
            ...
            >
              ...
              <p className="text-slate-600 text-sm">
                A member of our team will contact you within 24 hours to schedule your technical deep dive.
              </p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="john.smith@aicompany.com"
                />
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="vp-rd">VP/Director of R&D</option>
                  <option value="vp-product">VP/Director of Product</option>
                  <option value="vp-engineering">VP/Director of Engineering</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your AI performance analytics needs..."
                />
