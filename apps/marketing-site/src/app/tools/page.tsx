...
export default function ToolsPage() {
  return (
    <main className="max-w-2xl mx-auto py-12 px-4">
      <AISummary
        title="Encypher Tools - Free C2PA Encoding & Decoding"
        whatWeDo="Free tools from the Co-Chair of the C2PA Text Provenance Task Force. Encode and decode C2PA-compliant content authentication. Full API and SDKs in Python, TypeScript, Go, and Rust available."
