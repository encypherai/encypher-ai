...
const FEATURE_CATEGORIES: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'POST /api/v1/verify - Verify signed content',
        starter: 'Unlimited',
        professional: 'Unlimited',
        business: 'Unlimited',
        enterprise: 'Unlimited',
      ...
      },
      {
        ...
        description: 'GET /stats - API usage analytics',
        starter: '7 days',
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'POST /api/v1/enterprise/merkle/attribute',
        starter: false,
        professional: false,
        business: true,
        enterprise: true,
      },
      {
        ...
        description: 'POST /api/v1/enterprise/merkle/detect-plagiarism',
        starter: false,
        professional: false,
        business: true,
        enterprise: true,
      },
      {
        ...
        description: 'POST /api/v1/batch/sign & /batch/verify (100 docs)',
        starter: false,
        professional: false,
        business: '100 docs',
        enterprise: 'Unlimited',
  ...
  },
  {
    ...
    features: [
      {
        name: 'WebSocket Signing',
        description: 'WS /api/v1/stream/sign - Real-time signing',
        starter: false,
        professional: true,
        business: true,
        enterprise: true,
      },
      {
        ...
        description: 'WS /api/v1/stream/chat - For AI chat apps',
        starter: false,
        professional: true,
        business: true,
        enterprise: true,
