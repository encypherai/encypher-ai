...
**Files:**
- `includes/class-encypher-provenance-admin.php` (lines 288-424)
...
**Files:**
- `includes/class-encypher-provenance-rest.php` (lines 79-250)
...
**Files:**
- `includes/class-encypher-provenance-bulk.php` (full implementation)
...
**Files:**
- `includes/class-encypher-provenance-admin.php` (lines 33-648)
...
**Files:**
- `includes/class-encypher-provenance-frontend.php` (full implementation)
...
```
encypher-provenance/
├── encypher-provenance.php          # Main plugin file
├── README.md                        # Plugin documentation
├── includes/
│   ├── class-encypher-provenance.php              # Main bootstrap
│   ├── class-encypher-provenance-admin.php        # Admin & settings
│   ├── class-encypher-provenance-rest.php         # REST API
│   ├── class-encypher-provenance-verification.php # Verification
│   ├── class-encypher-provenance-bulk.php         # Bulk marking
│   └── class-encypher-provenance-frontend.php     # Frontend badge
├── assets/
│   ├── js/
...
└── languages/
    └── encypher-provenance.pot       # Translation template
```
...
**WordPress REST API:**
```
POST /wp-json/encypher-provenance/v1/sign
GET  /wp-json/encypher-provenance/v1/status
POST /wp-json/encypher-provenance/v1/verify
```
