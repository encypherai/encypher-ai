...
class Bulk
{
    ...
    public function register_bulk_page(): void
    {
        add_submenu_page(
            'tools.php',
            __('Encypher C2PA - Bulk Mark', 'encypher-assurance'),
            __('Encypher C2PA', 'encypher-assurance'),
            'manage_options',
            'encypher-bulk-mark',
    ...
    public function render_bulk_page(): void
    {
        ...
        <div class="wrap encypher-bulk-mark-page">
            <h1><?php esc_html_e('Bulk Mark WordPress Archives', 'encypher-assurance'); ?></h1>
            
            <div class="encypher-bulk-intro">
                <p><?php esc_html_e('Programmatically mark existing WordPress content with C2PA-compliant invisible embeddings.', 'encypher-assurance'); ?></p>
            </div>

            <?php if ('free' === $tier): ?>
            <div class="notice notice-info">
                <p>
                    <strong><?php esc_html_e('Free Tier Limit:', 'encypher-assurance'); ?></strong>
                    <?php esc_html_e('You can mark up to 100 posts per bulk operation.', 'encypher-assurance'); ?>
                    <a href="https://encypherai.com/pricing" target="_blank"><?php esc_html_e('Upgrade to Pro for unlimited marking', 'encypher-assurance'); ?></a>
                </p>
            </div>
            <?php endif; ?>

            <div class="encypher-bulk-form">
                <h2><?php esc_html_e('Select Content to Mark', 'encypher-assurance'); ?></h2>
                
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php esc_html_e('Post Types', 'encypher-assurance'); ?></th>
                        <td>
                            <?php foreach ($post_types as $post_type): ?>
                                ...
                                <label>
                                    ...
                                    <span class="description">(<?php echo esc_html($total); ?> <?php esc_html_e('found', 'encypher-assurance'); ?>)</span>
                                </label><br>
                            <?php endforeach; ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row"><?php esc_html_e('Date Range', 'encypher-assurance'); ?></th>
                        <td>
                            <select name="date_range" id="encypher-date-range">
                                <option value="all"><?php esc_html_e('All Time', 'encypher-assurance'); ?></option>
                                <option value="last_month"><?php esc_html_e('Last Month', 'encypher-assurance'); ?></option>
                                <option value="last_3_months"><?php esc_html_e('Last 3 Months', 'encypher-assurance'); ?></option>
                                <option value="last_6_months"><?php esc_html_e('Last 6 Months', 'encypher-assurance'); ?></option>
                                <option value="last_year"><?php esc_html_e('Last Year', 'encypher-assurance'); ?></option>
                                <option value="custom"><?php esc_html_e('Custom Range', 'encypher-assurance'); ?></option>
                            </select>
                            
                            <div id="encypher-custom-date-range" style="display:none; margin-top:10px;">
                                <label>
                                    <?php esc_html_e('From:', 'encypher-assurance'); ?>
                                    <input type="date" name="date_from" id="encypher-date-from">
                                </label>
                                <label style="margin-left:10px;">
                                    <?php esc_html_e('To:', 'encypher-assurance'); ?>
                    ...
                    <tr>
                        <th scope="row"><?php esc_html_e('Status Filter', 'encypher-assurance'); ?></th>
                        <td>
                            <label>
                                <input type="radio" name="status_filter" value="unmarked" checked>
                                <?php esc_html_e('Unmarked Only', 'encypher-assurance'); ?>
                                <span class="description"><?php esc_html_e('(Recommended)', 'encypher-assurance'); ?></span>
                            </label><br>
                            <label>
                                <input type="radio" name="status_filter" value="all">
                                <?php esc_html_e('All Posts', 'encypher-assurance'); ?>
                                <span class="description"><?php esc_html_e('(Re-mark already marked posts)', 'encypher-assurance'); ?></span>
                            </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row"><?php esc_html_e('Batch Size', 'encypher-assurance'); ?></th>
                        <td>
                            <input type="number" name="batch_size" id="encypher-batch-size" value="10" min="1" max="50">
                            <p class="description"><?php esc_html_e('Number of posts to process per batch (1-50). Lower values are safer for slow servers.', 'encypher-assurance'); ?></p>
                        </td>
                    </tr>
                </table>

                <div class="encypher-bulk-summary">
                    <h3><?php esc_html_e('Summary', 'encypher-assurance'); ?></h3>
                    <p>
                        <strong><?php esc_html_e('Total posts to mark:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-total-count">0</span>
                    </p>
                    <?php if ('free' === $tier): ?>
                    <p class="encypher-tier-limit">
                        <strong><?php esc_html_e('Free tier limit:', 'encypher-assurance'); ?></strong>
                        <?php esc_html_e('100 posts', 'encypher-assurance'); ?>
                    </p>
                    <?php endif; ?>
                </div>
                ...
                <p class="submit">
                    <button type="button" id="encypher-start-bulk-mark" class="button button-primary button-large">
                        <?php esc_html_e('Start Bulk Marking', 'encypher-assurance'); ?>
                    </button>
                </p>
            </div>

            <div class="encypher-bulk-progress" style="display:none;">
                <h2><?php esc_html_e('Bulk Marking Progress', 'encypher-assurance'); ?></h2>
                ...
                <p class="encypher-progress-status">
                    ...
                    <span id="encypher-progress-status-text"><?php esc_html_e('Initializing...', 'encypher-assurance'); ?></span>
                </p>
                
                <p class="encypher-progress-current-post">
                    <strong><?php esc_html_e('Current:', 'encypher-assurance'); ?></strong>
                ...
                <div class="encypher-progress-stats">
                    <p>
                        <strong><?php esc_html_e('Successful:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-success-count">0</span>
                    </p>
                    <p>
                        <strong><?php esc_html_e('Failed:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-error-count">0</span>
                        <a href="#" id="encypher-view-errors" style="display:none;"><?php esc_html_e('View Errors', 'encypher-assurance'); ?></a>
                    </p>
                    <p>
                        <strong><?php esc_html_e('Elapsed Time:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-elapsed-time">0s</span>
                    </p>
                </div>

                <div class="encypher-error-log" style="display:none;">
                    <h3><?php esc_html_e('Error Log', 'encypher-assurance'); ?></h3>
                    <ul id="encypher-error-list"></ul>
                </div>

                <p class="encypher-progress-actions">
                    <button type="button" id="encypher-pause-bulk-mark" class="button">
                        <?php esc_html_e('Pause', 'encypher-assurance'); ?>
                    </button>
                    <button type="button" id="encypher-cancel-bulk-mark" class="button">
                        <?php esc_html_e('Cancel', 'encypher-assurance'); ?>
                    </button>
                </p>
            </div>

            <div class="encypher-bulk-complete" style="display:none;">
                <h2><?php esc_html_e('Bulk Marking Complete!', 'encypher-assurance'); ?></h2>
                
                <div class="notice notice-success">
                    <p>
                        <strong><?php esc_html_e('Successfully marked:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-final-success-count">0</span> <?php esc_html_e('posts', 'encypher-assurance'); ?>
                    </p>
                    <?php /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>
                    <p id="encypher-final-errors" style="display:none;">
                        <strong><?php esc_html_e('Failed:', 'encypher-assurance'); ?></strong>
                        <span id="encypher-final-error-count">0</span> <?php esc_html_e('posts', 'encypher-assurance'); ?>
                    </p>
                </div>

                <p>
                    <button type="button" id="encypher-start-new-bulk" class="button button-primary">
                        <?php esc_html_e('Mark More Posts', 'encypher-assurance'); ?>
                    </button>
                </p>
            </div>
        </div>
    ...
    public function handle_bulk_mark_batch(): void
    {
        ...
        if (! current_user_can('manage_options')) {
            wp_send_json_error(['message' => __('Insufficient permissions.', 'encypher-assurance')]);
        }

        $post_ids = isset($_POST['post_ids']) ? array_map('intval', (array) $_POST['post_ids']) : [];
        
        if (empty($post_ids)) {
            wp_send_json_error(['message' => __('No post IDs provided.', 'encypher-assurance')]);
        }
        ...
        if ('free' === $tier && count($post_ids) > 100) {
            wp_send_json_error([
                'message' => __('Free tier limit: 100 posts per bulk operation. Upgrade to Pro for unlimited marking.', 'encypher-assurance')
            ]);
        }
        ...
        foreach ($post_ids as $post_id) {
            ...
            if (! $post) {
                $results[] = [
                    'post_id' => $post_id,
                    'success' => false,
                    'error' => __('Post not found.', 'encypher-assurance')
                ];
                continue;
            }
