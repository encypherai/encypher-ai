...
Returns:
	...
	*/
	...
	//  @return interface{}
	RootGetExecute(r ApiRootGetRequest) (interface{}, *http.Response, error)
}
...
//  @return interface{}
func (a *InfoAPIService) RootGetExecute(r ApiRootGetRequest) (interface{}, *http.Response, error) {
	var (
