...
type VerifyResponse struct {
	...
	Data NullableAppModelsResponseModelsVerifyVerdict `json:"data,omitempty"`
...
// SetData gets a reference to the given NullableAppModelsResponseModelsVerifyVerdict and assigns it to the Data field.
