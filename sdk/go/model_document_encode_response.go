...
type DocumentEncodeResponse struct {
	...
	FuzzyIndex map[string]interface{} `json:"fuzzy_index,omitempty"`
}
...
// GetFuzzyIndex returns the FuzzyIndex field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetFuzzyIndexOk returns a tuple with the FuzzyIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DocumentEncodeResponse) GetFuzzyIndexOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.FuzzyIndex) {
		return map[string]interface{}{}, false
	}
	return o.FuzzyIndex, true
}
...
// SetFuzzyIndex gets a reference to the given map[string]interface{} and assigns it to the FuzzyIndex field.
...
func (o DocumentEncodeResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.FuzzyIndex != nil {
		toSerialize["fuzzy_index"] = o.FuzzyIndex
	}
