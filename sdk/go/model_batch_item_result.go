...
type BatchItemResult struct {
	...
	Verdict NullableAppModelsResponseModelsVerifyVerdict `json:"verdict,omitempty"`
...
func (o *BatchItemResult) GetVerdict() AppModelsResponseModelsVerifyVerdict {
	if o == nil || IsNil(o.Verdict.Get()) {
		var ret AppModelsResponseModelsVerifyVerdict
		return ret
	}
...
// SetVerdict gets a reference to the given NullableAppModelsResponseModelsVerifyVerdict and assigns it to the Verdict field.
