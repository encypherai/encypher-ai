...
// checks if the QuotaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaResponse{}
...
type _QuotaResponse QuotaResponse
...
func (o QuotaResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QuotaResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varQuotaResponse := _QuotaResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQuotaResponse)

	if err != nil {
		return err
	}

	*o = QuotaResponse(varQuotaResponse)
