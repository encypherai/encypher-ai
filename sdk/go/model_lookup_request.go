...
// GetSentenceText returns the SentenceText field value
func (o *LookupRequest) GetSentenceText() string {
	...
	return o.SentenceText
}

// GetSentenceTextOk returns a tuple with the SentenceText field value
// and a boolean to check if the value has been set.
func (o *LookupRequest) GetSentenceTextOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SentenceText, true
}

// SetSentenceText sets field value
...
func (o LookupRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["sentence_text"] = o.SentenceText
