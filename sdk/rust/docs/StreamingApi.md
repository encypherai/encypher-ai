...
> serde_json::Value close_streaming_session_api_v1_sign_stream_sessions_session_id_close_post(session_id)
...
> serde_json::Value create_streaming_session_api_v1_sign_stream_sessions_post(session_type, body_create_streaming_session_api_v1_sign_stream_sessions_post)
...
**body_create_streaming_session_api_v1_sign_stream_sessions_post** | Option<[**BodyCreateStreamingSessionApiV1SignStreamSessionsPost**](BodyCreateStreamingSessionApiV1SignStreamSessionsPost.md)> |  |  |
...
> serde_json::Value get_stream_run_api_v1_sign_stream_runs_run_id_get(run_id)
Get Stream Run
...
> serde_json::Value get_streaming_stats_api_v1_sign_stream_stats_get()
Get Streaming Stats
...
> serde_json::Value sse_events_endpoint_api_v1_sign_stream_sessions_session_id_events_get(session_id, api_key)
Sse Events Endpoint
