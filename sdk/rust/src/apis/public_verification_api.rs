...
pub async fn batch_verify_embeddings_api_v1_public_verify_batch_post(configuration: &configuration::Configuration, batch_verify_request: models::BatchVerifyRequest, authorization: Option<&str>) -> Result<models::BatchVerifyResponse, Error<BatchVerifyEmbeddingsApiV1PublicVerifyBatchPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_batch_verify_request = batch_verify_request;
    ...
    req_builder = req_builder.json(&p_body_batch_verify_request);
