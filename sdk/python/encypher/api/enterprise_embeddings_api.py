...
class EnterpriseEmbeddingsApi:
    ...
    @validate_call
    def encode_with_embeddings_api_v1_enterprise_embeddings_encode_with_embeddings_post(
        self,
    ...
    @validate_call
    def encode_with_embeddings_api_v1_enterprise_embeddings_encode_with_embeddings_post_with_http_info(
        self,
        encode_with_embeddings_request: EncodeWithEmbeddingsRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def encode_with_embeddings_api_v1_enterprise_embeddings_encode_with_embeddings_post_without_preload_content(
        self,
        encode_with_embeddings_request: EncodeWithEmbeddingsRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _encode_with_embeddings_api_v1_enterprise_embeddings_encode_with_embeddings_post_serialize(
        self,
