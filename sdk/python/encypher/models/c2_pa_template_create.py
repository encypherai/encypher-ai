...
class C2PATemplateCreate(BaseModel):
    ...
    schema_id: StrictStr = Field(description="ID of the schema this template uses")
    template_data: Dict[str, Any] = Field(description="Template data/configuration")
    description: Optional[StrictStr] = None
    category: Optional[StrictStr] = None
    is_public: Optional[StrictBool] = Field(default=False, description="Whether template is publicly accessible")
    __properties: ClassVar[List[str]] = ["name", "schema_id", "template_data", "description", "category", "is_public"]
