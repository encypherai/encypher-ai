...
class MemberRevenueDetail(BaseModel):
    ...
    id: UUID
    member_id: UUID
    content_count: StrictInt
    access_count: StrictInt
    revenue_amount: Annotated[str, Field(strict=True)]
    status: PayoutStatus
    paid_at: Optional[datetime]
    payment_reference: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "member_id", "content_count", "access_count", "revenue_amount", "status", "paid_at", "payment_reference"]

    @field_validator('revenue_amount')
    def revenue_amount_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content_count": obj.get("content_count"),
            "access_count": obj.get("access_count"),
            "revenue_amount": obj.get("revenue_amount"),
