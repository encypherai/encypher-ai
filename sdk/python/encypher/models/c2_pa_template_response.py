...
class C2PATemplateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "schema_id", "template_data", "category", "organization_id", "is_default", "is_active", "is_public", "created_at", "updated_at"]
