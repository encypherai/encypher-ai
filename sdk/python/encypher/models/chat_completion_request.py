...
class ChatCompletionRequest(BaseModel):
    ...
    sign_response: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["messages", "model", "temperature", "top_p", "n", "stream", "stop", "max_tokens", "presence_penalty", "frequency_penalty", "user", "sign_response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": obj.get("user"),
            "sign_response": obj.get("sign_response") if obj.get("sign_response") is not None else True
        })
        return _obj
