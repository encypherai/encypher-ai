...
class AutoProvisionRequest(BaseModel):
    ...
    organization_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    source: StrictStr = Field(description="Source of the provisioning request")
    source_metadata: Optional[Dict[str, Any]] = None
    tier: Optional[StrictStr] = None
    auto_activate: Optional[StrictBool] = Field(default=True, description="Whether to automatically activate the organization")
    __properties: ClassVar[List[str]] = ["email", "organization_name", "source", "source_metadata", "tier", "auto_activate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tier": obj.get("tier"),
            "auto_activate": obj.get("auto_activate") if obj.get("auto_activate") is not None else True
        })
        return _obj
