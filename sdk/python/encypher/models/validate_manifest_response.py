...
class ValidateManifestResponse(BaseModel):
    ...
    assertions: Optional[List[C2PAAssertionValidationResult]] = None
    __properties: ClassVar[List[str]] = ["valid", "errors", "warnings", "assertions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assertions": [C2PAAssertionValidationResult.from_dict(_item) for _item in obj["assertions"]] if obj.get("assertions") is not None else None
        })
        return _obj
