...
class C2PATemplateListResponse(BaseModel):
    ...
    page: StrictInt
    page_size: StrictInt
    __properties: ClassVar[List[str]] = ["templates", "total", "page", "page_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [C2PATemplateResponse.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
