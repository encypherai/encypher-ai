...
class EvidenceGenerateResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool = Field(description="Whether evidence generation succeeded")
    ...
    __properties: ClassVar[List[str]] = ["success", "evidence", "processing_time_ms", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evidence": EvidencePackage.from_dict(obj["evidence"]) if obj.get("evidence") is not None else None,
