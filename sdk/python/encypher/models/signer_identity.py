...
class SignerIdentity(BaseModel):
    ...
    trust_level: Optional[StrictStr] = 'unknown'
    __properties: ClassVar[List[str]] = ["organization_id", "organization_name", "trust_level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trust_level": obj.get("trust_level") if obj.get("trust_level") is not None else 'unknown'
        })
        return _obj
