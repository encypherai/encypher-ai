...
[**get_progression_status_api_v1_onboarding_progression_status_get**](OnboardingApi.md#get_progression_status_api_v1_onboarding_progression_status_get) | **GET** /api/v1/onboarding/progression-status | Get publisher value journey progression status
...
# **get_progression_status_api_v1_onboarding_progression_status_get**
> ProgressionStatusResponse get_progression_status_api_v1_onboarding_progression_status_get()

Get publisher value journey progression status

Returns the publisher's current stage in the 6-stage value journey: Sign -> Verify -> Spread -> Notice Ready -> Licensing -> Earnings. Used to power the progression component on the home page and analytics page.
...
with encypher.ApiClient(configuration) as api_client:
    ...
    try:
        # Get publisher value journey progression status
        api_response = api_instance.get_progression_status_api_v1_onboarding_progression_status_get()
        print("The response of OnboardingApi->get_progression_status_api_v1_onboarding_progression_status_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OnboardingApi->get_progression_status_api_v1_onboarding_progression_status_get: %s\n" % e)
```
...
[**ProgressionStatusResponse**](ProgressionStatusResponse.md)
