...
json = "{}"
# create an instance of BatchSignRequest from a JSON string
batch_sign_request_instance = BatchSignRequest.from_json(json)
# print the JSON string representation of the object
print(BatchSignRequest.to_json())

# convert the object into a dict
batch_sign_request_dict = batch_sign_request_instance.to_dict()
# create an instance of BatchSignRequest from a dict
batch_sign_request_from_dict = BatchSignRequest.from_dict(batch_sign_request_dict)
```
