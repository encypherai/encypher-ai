...
class OrganizationService:
    ...
    def remove_member(
        ...
        self._log_action(
            ...
            'member',
            member.id,
            {'removed_user_id': target_user_id, 'removed_user_email': user_email}
        )
    ...
    def get_seat_count(self, org_id: str) -> dict:
        ...
        pending_count = self.db.query(OrganizationInvitation).filter(
            and_(
    ...
    def create_invitation(
        ...
        existing_invite = self.db.query(OrganizationInvitation).filter(
            and_(
                OrganizationInvitation.organization_id == org_id,
