...
class TestOrganizationAPI:
    ...
    async def auth_headers(self):
        ...
        async with httpx.AsyncClient() as client:
            ...
            return {
                "Authorization": f"Bearer {tokens['data']['access_token']}",
                "email": email
            }
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                ...
                json={
                    ...
                    "email": f"org_{secrets.token_hex(4)}@example.com"
                }
            )
    ...
    async def test_list_organizations(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            await client.post(
                ...
                json={
                    "name": "List Test Org",
                    "email": f"listorg_{secrets.token_hex(4)}@example.com"
                }
            )
    ...
    async def test_get_organization(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    "name": "Get Test Org",
                    "email": f"getorg_{secrets.token_hex(4)}@example.com"
                }
            )
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    ...
                    "email": f"updateorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    ...
                    "email": f"membersorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
    ...
    async def test_get_seats(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    "name": "Seats Test Org",
                    "email": f"seatsorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
            ...
            # Get seats
            response = await client.get(
                f"{BASE_URL}/api/v1/organizations/{org_id}/seats",
                headers={"Authorization": auth_headers["Authorization"]}
            )
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    ...
                    "email": f"inviteorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
    ...
    async def test_list_invitations(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                headers={"Authorization": auth_headers["Authorization"]},
                json={
                    "name": "List Invites Org",
                    "email": f"listinvorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
            ...
            await client.post(
                ...
                headers={"Authorization": auth_headers["Authorization"]},
                json={
                    "email": f"listinv_{secrets.token_hex(4)}@example.com",
                    "role": "member"
                }
            )
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    ...
                    "email": f"cancelorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
            ...
            invite_response = await client.post(
                ...
                headers={"Authorization": auth_headers["Authorization"]},
                json={
                    "email": f"cancel_{secrets.token_hex(4)}@example.com",
                    "role": "member"
                }
            )
            ...
            response = await client.delete(
                f"{BASE_URL}/api/v1/organizations/{org_id}/invitations/{invitation_id}",
                headers={"Authorization": auth_headers["Authorization"]}
            )
    ...
    async def test_get_audit_logs(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                json={
                    "name": "Audit Log Org",
                    "email": f"auditorg_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
    ...
    async def test_cannot_invite_as_owner_role(self, auth_headers):
        ...
        async with httpx.AsyncClient() as client:
            ...
            create_response = await client.post(
                ...
                headers={"Authorization": auth_headers["Authorization"]},
                json={
                    "name": "Owner Role Test Org",
                    "email": f"ownerrole_{secrets.token_hex(4)}@example.com"
                }
            )
            org_id = create_response.json()["data"]["id"]
...
class TestInvitationPublicEndpoints:
    ...
    async def test_get_invitation_details_invalid_token(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{BASE_URL}/api/v1/organizations/invitations/invalid_token_123"
            )
