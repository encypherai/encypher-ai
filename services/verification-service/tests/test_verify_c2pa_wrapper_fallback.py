...
def test_verify_c2pa_wrapper_fallback_when_unicode_metadata_raises(client, monkeypatch) -> None:
    ...
    monkeypatch.setattr(verify_endpoints.UnicodeMetadata, "verify_metadata", staticmethod(_boom))
