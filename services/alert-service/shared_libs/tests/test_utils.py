...
class TestUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_result1 = VerificationResult(
            verified=True, signer_id="test-signer", raw_payload={"timestamp": "2025-06-03T11:00:00", "model_id": "test-model"}
        )
        self.mock_result2 = VerificationResult(verified=False, signer_id=None, raw_payload={})
    ...
    def test_scan_directory(self, mock_path):
        ...
        # Call the function
        results = scan_directory(directory_path="/test/dir", encypher_ai=self.encypher, file_extensions=[".txt", ".md"], show_progress=False)
    ...
    def test_generate_report(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = {"file1.txt": self.mock_result1, "file2.md": self.mock_result2}
