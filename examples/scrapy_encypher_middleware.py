...
class EncypherMiddleware:
    ...
    def __init__(self, partner_api_key, partner_id, batch_size):
        ...
        self.stats = {"pages_processed": 0, "embeddings_found": 0, "valid_embeddings": 0, "findings_reported": 0}
    ...
    def from_crawler(cls, crawler):
        ...
        # Create middleware
        middleware = cls(partner_api_key=partner_api_key, partner_id=partner_id, batch_size=batch_size)
