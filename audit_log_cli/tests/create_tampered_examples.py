...
try:
    ...
    um = UnicodeMetadata(private_key_data=private_key_data, signer_id="test-signer", verbose=True)
...
"""
    ...
    try:
        ...
        custom_metadata = {"purpose": "testing", "example": "tampered_variation_selectors", "document_id": "doc-vs-123", "version": "1.0.0"}
    ...
    console.print(
        "uv run -- python -m audit_log_cli.app.main --target audit_log_cli/tests/tampered_examples --trusted-signers audit_log_cli/tests/tampered_examples/keys --verify-content-integrity"
    )
