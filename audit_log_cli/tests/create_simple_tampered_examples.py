...
"""
    ...
    try:
        ...
        custom_metadata = {"purpose": "testing", "example": "tampered_example", "document_id": "doc-123", "version": "1.0.0"}
        ...
        if len(lines) > 2:
            ...
            tampered_text = original_with_metadata.replace(
                "This file should pass verification", "This file should pass verification [THIS TEXT WAS MODIFIED AFTER SIGNING]"
            )
                    ...
                    try:
                        ...
                        try:
                            ...
                            if os.path.exists(dejavu_path):
                                ...
                                arial_unicode_paths = [r"C:\Windows\Fonts\ARIALUNI.TTF", r"C:\Windows\Fonts\Arial Unicode MS.ttf"]
                                ...
                                for font_path in arial_unicode_paths:
                                    ...
                                    font_name = "Helvetica"
                                    console.print(
                                        "[yellow]Unicode-compatible fonts not found, using Helvetica (Unicode support may be limited)[/yellow]"
                                    )
                        except Exception as e:
    ...
    console.print(
        "uv run -- python -m audit_log_cli.app.main --target audit_log_cli/tests/simple_tampered_examples --trusted-signers audit_log_cli/tests/simple_tampered_examples/keys --verify-content-integrity"
    )
