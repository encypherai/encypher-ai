...
"""
        ...
        original_with_metadata = ea_test.embed_metadata(
            text=example4_text,
            custom_metadata=original_metadata,
        ...
        if len(lines) > 2:
            ...
            tampered_text = original_with_metadata.replace(
                "This file should fail verification",
                "This file should fail verification [THIS TEXT WAS MODIFIED AFTER SIGNING]"
            )
