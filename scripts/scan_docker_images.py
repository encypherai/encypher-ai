...
def run_simple_scan(image: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"output": result.stdout or "", "error": result.stderr if result.returncode != 0 else None, "returncode": result.returncode}
    except Exception as e:
...
def main():
    ...
    for image in existing_images:
        ...
        results[image] = {"critical": critical_count, "high": high_count}
