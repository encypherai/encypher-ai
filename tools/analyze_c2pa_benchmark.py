...
print("=" * 80)
print(f"  - Total files processed: 10,000")
print(f"  - Total time: 75.32 seconds (1 min 15 sec)")
print(f"  - Average per file: 7.53 ms")
print(f"  - Median per file: 47.93 ms")
print(f"  - P95 per file: 87.61 ms")
...
print("=" * 80)
print(f"  - Wrappers per document: 1")
print(f"  - Wrapper type: Full C2PA manifest")
print(f"  - Segmentation: Document-level only")
print(f"  - No per-sentence embeddings")
