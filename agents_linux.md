...
3. **Broken Reference Check**: The file `project_structure_rules.md` referenced in global memories does not exist; use this file (`agents_linux.md`) as the source of truth.
...
4. **File Paths**: Always use **absolute paths** (e.g., `/home/developer/code/encypherai-commercial/...`) in tool calls.
