...
class TestCoalitionStatsEndpoint:
    ...
    async def test_get_stats_no_member_record(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict,
...
class TestCoalitionRevenueEndpoint:
    ...
    async def test_get_revenue_success(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict,
    ...
    async def test_get_revenue_with_period_filter(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict,
        ...
        response = await client.get(
            "/api/v1/coalition/revenue?period=month",
            headers=auth_headers
        )
...
class TestContentPerformanceEndpoint:
    ...
    async def test_get_top_content_success(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict,
        ...
        response = await client.get(
            "/api/v1/coalition/content/performance?limit=5",
            headers=auth_headers
        )
    ...
    async def test_get_top_content_invalid_limit(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
        ...
        response = await client.get(
            "/api/v1/coalition/content/performance?limit=0",
            headers=auth_headers
        )
...
class TestCreateContentEndpoint:
    ...
    async def test_create_content_for_other_user_forbidden(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict
...
class TestAdminEndpoints:
    ...
    async def test_admin_overview_success(
        self,
        client: AsyncClient,
        admin_user: User,
    ...
    async def test_admin_overview_non_admin_forbidden(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
    ...
    async def test_get_members_list_success(
        ...
        response = await client.get(
            "/api/v1/coalition/admin/members?skip=0&limit=50",
            headers=admin_auth_headers
        )
    ...
    async def test_get_members_list_non_admin_forbidden(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
        ...
        response = await client.get(
            "/api/v1/coalition/admin/members",
            headers=auth_headers
        )
...
class TestAccessLogEndpoint:
    ...
    async def test_create_access_log_success(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict,
...
class TestMemberInfoEndpoint:
    ...
    async def test_get_member_info_creates_if_not_exists(
        self,
        client: AsyncClient,
        test_user: User,
        auth_headers: dict
