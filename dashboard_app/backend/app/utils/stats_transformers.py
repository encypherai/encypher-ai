...
def transform_audit_log_stats(stats: AuditLogStats, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        logs_by_day = generate_daily_stats(
            start_date, 
            end_date, 
...
def transform_validation_stats(stats: PolicyValidationStats, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        validations_by_day = generate_daily_stats(
            start_date, 
            end_date, 
            stats.total_documents
        )
