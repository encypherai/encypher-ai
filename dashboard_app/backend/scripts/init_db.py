        ...
        try:
            ...
            if policy_count == 0:
                ...
                basic_policy = PolicySchema(
                    ...
                    schema={
                        "rules": [
                            {"key": "model_id", "required": True, "type": "string"},
                            {
                                "key": "department",
                                "required": True,
                                "type": "string",
                ...
                advanced_policy = PolicySchema(
                    ...
                    schema={
                        "rules": [
                            ...
                            {"key": "data_sensitivity", "required": True, "type": "string", "allowed_values": ["low", "medium", "high"]},
                            {"key": "retention_period", "required": False, "type": "integer"},
                        ]
                    },
                )
