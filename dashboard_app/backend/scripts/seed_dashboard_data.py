...
ERROR_MESSAGES = ["Invalid metadata format", "Missing required fields", "Schema validation failed", "Unauthorized access", "Resource not found"]
ERROR_TYPES = ["missing_field", "invalid_format", "size_exceeded", "unauthorized_access", "schema_mismatch"]
