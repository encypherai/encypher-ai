# Global Agent Directives (Linux Optimized)
...
| Agent Rules | `agents_linux.md` (per-project) |
...
Before code: 1) Read README 2) Read active PRD 3) Read agents_linux.md 4) Check .teams/ 5) Claim Team ID 6) Verify tests pass 7) Begin
## Rule 6 — Session End
...
## Rule 11 — Tool Usage
1) Search First: Fast Context, find_by_name, grep_search 2) Read Before Edit: MUST read_file before edit 3) Absolute paths (Root: `/home/developer/code/encypherai-commercial`) 4) Case-insensitive grep default
