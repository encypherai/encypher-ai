...
Encypher is provided under a dual licensing model designed to support both open-source community use and commercial enterprise adoption.

## Open Source License (AGPL-3.0)

The core Encypher package is released under the [GNU Affero General Public License v3.0 (AGPL-3.0)](https://www.gnu.org/licenses/agpl-3.0.en.html). This license allows you to use, modify, and distribute the software freely, provided that:
...
The AGPL-3.0 license is designed to ensure that improvements to Encypher remain open and available to the community.

## Commercial License

For organizations that wish to incorporate Encypher into proprietary applications without the source code disclosure requirements of AGPL-3.0, we offer a commercial licensing option.

Benefits of the commercial license include:

- **Proprietary Integration**: Use Encypher in closed-source applications without AGPL obligations
...
- **AGPL-3.0 is appropriate if**:
  - You're using Encypher for research, education, or personal projects
...
- **Commercial license is recommended if**:
  - You're integrating Encypher into a proprietary product
...
When using Encypher under the AGPL-3.0 license, ensure you:
